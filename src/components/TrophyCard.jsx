...
const TrophyCard = ({ title, index }) => {
    ...
    return (
        <motion.div
            ...
            className="bg-gradient-to-br from-gray-800/50 to-gray-900/80 backdrop-blur-md border border-white/5 rounded-xl overflow-hidden shadow-lg group hover:shadow-purple-500/20 hover:border-purple-500/30 transition-all duration-300"
        >
